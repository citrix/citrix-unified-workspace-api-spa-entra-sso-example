...
services.AddAuthentication(options =>
    ...
    .AddCookie(
        options =>
        {
            options.Cookie.Name = ".TMS.AspNetCore.Cookies";
...
builder.Services.AddCors(options =>
{
    ...
    {
        policy.AllowCredentials().AllowAnyHeader().AllowAnyMethod().WithOrigins(frontEndSettings.FrontEndCorsOrigin, "https://accounts.cloud.com");
    });
});
